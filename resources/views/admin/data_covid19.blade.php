...
<style type="text/css">
	/* DataTables */
	@imporw url('{{ asset("plugins/datatables-bs4/css/dataTables.bootstrap4.min.css") }}');
...
<script type="text/javascript">
	function tambah_data(){
		...
		$('#form_data').attr('action', '/admin/data_covid19/simpan_data');
	...
	function ubah_data(id){
		...
		$('#form_data').attr('action', '/admin/data_covid19/ubah_data');
	...
	function hapus_data(id){
		$('#hapus_data').attr('href', '/admin/data_covid19/hapus_data/'+id);
	}
